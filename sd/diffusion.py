...
class UNET_ResidualBlock(nn.Module):
    def __init__(self,in_channels:int, out_channels:int, n_time=1200 ):
        ...
        self.conv_merged = nn.Conv2d(out_channels, out_channels, padding=1, kernel_size=3)
...
class UNET_AttentionBlock(nn.Module):
    ...
    def forward(self, x, context):
        ...
        x += residue_short
        # Normalizartion + Cross Attention
...
class Diffusion(nn.Module):
    ...
    def forward(self, noise:torch.Tensor, context: torch.Tensor, time: torch.Tensor):
        # time: (1,320)
        ...
        output = self.unet(noise, context, time)
